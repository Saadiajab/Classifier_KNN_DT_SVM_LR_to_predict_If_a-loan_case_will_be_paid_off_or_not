...
Your Pages site will use the layout and styles from the Jekyll theme you have selected in your [repository settings](https://github.com/Saadiajab/Classifier_KNN_DT_SVM_LR_to_predict_If_a-loan_case_will_be_paid_off_or_not/settings). The name of this theme is saved in the Jekyll `_config.yml` configuration file.
